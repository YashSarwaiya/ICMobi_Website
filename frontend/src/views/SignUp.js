      ...
      {({ Auth, signup }) => {
        ...
        if (Auth === "Admin") {
          return (
            <div>
              <p>
                You already signed in. Please sign out to sign up for another
                account.
              </p>
            </div>
          );
                    ...
                    <Row>
                      ...
                      <Col>
                        <Form.Group>
                          ...
                          <Form.Select onChange={(e) => setEdu(e.target.value)}>
                      ...
                      <Col>
                        <Form.Group>
                          <Form.Label style={{ float: "left" }}>
                            Experience with EEG Labeling
                          </Form.Label>
                          <Form.Select onChange={(e) => setExp(e.target.value)}>
                      ...
                      <Col>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            if (
                              typeof assoc[0] === "string" ||
                              assoc[0] instanceof String
                            ) {
                              assocSel = assoc[0];
                            } else if (
                              typeof assoc[0] === "object" &&
                              assoc[0] !== null
                            ) {
