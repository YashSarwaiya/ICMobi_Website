          ...
          this.setState(
            {
              ...
              Auth: role, // This stays as role
              Info: JSON.stringify(response.data), // FIXED: was "role", should be response data
            ...
            () => {
              ...
              localStorage.setItem("Info", JSON.stringify(response.data)); // FIXED
              localStorage.setItem("Name", response.data.fname);
              localStorage.setItem("token", response.data.accessToken); // ADDED
            }
          );
        }
